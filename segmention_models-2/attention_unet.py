...
epoch_size = 200
MODEL_PATH = "model/attention_params_d0.pkl"
...
if __name__ == '__main__':
    ...
    with open(file='mymethod_d2_loss.csv', mode='w', encoding='utf-8', newline='') as f:
        write = csv.DictWriter(f, fieldnames=header1)
        write.writeheader()
        write.writerows(LOSS_dic)
    with open(file='mymethod_d2_dicemean.csv', mode='w', encoding='utf-8', newline='') as f:
