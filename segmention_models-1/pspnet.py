...
[description]
PSPNet
https://github.com/charlesCXK/PyTorch_Semantic_Segmentation/blob/master/PSPNet_PyTorch/pspnet.py
'''
...
class PSPNet(nn.Module):
    def __init__(self, n_classes, bn_momentum=0.01):
        super(PSPNet, self).__init__()
        self.name = self.__class__.__name__
        self.n_classes = n_classes
        self.n_channels = 3
        self.Resnet101 = get_resnet101(dilation=[1, 1, 1, 2], bn_momentum=bn_momentum, is_fpn=False)
        self.psp_layer = PyramidPooling('psp', n_classes, 2048, norm_layer=nn.BatchNorm2d)
